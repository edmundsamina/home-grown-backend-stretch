...
export async function getUserAndPlotByFirebaseID(firebase_id) {
  ...
  export async function createNewUser(body){
    const sqlQuery = `WITH step_one AS ( INSERT INTO users (firebase_id, profile_picture, first_name, last_name, email, username, rating) VALUES ($1, $2, $3, $4, $5, $6, $7)) INSERT INTO plots (firebase_id) VALUES ($1) RETURNING *`;
